...
namespace Korki.Areas.Identity.Pages.Account
{
    ...
    public class RegisterAsTutorModel : PageModel
    {
        ...
        {
            [Required]
            [StringLength(40, ErrorMessage = "{0} musi mieć długość min. {2} i max. {1} znaków", MinimumLength = 5)]
            ...
            [Required]
            [StringLength(100, ErrorMessage = "{0} musi mieć długość min. {2} i max. {1} znaków.", MinimumLength = 8)]
            ...
            [Compare("Password", ErrorMessage = "Hasło i powtórzone hasło muszą być identyczne.")]
